...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('secondary_transports', function (Blueprint $table) {
            ...
            $table->index(['transport_date', 'supplier_transporter_id'], 'sect_date_supplier_idx');
        });

        // ── Secondary Transport Bills (header) ───────────────────────────────
        Schema::create('secondary_transport_bills', function (Blueprint $table) {
            ...
            $table->index(['bill_date', 'supplier_transporter_id'], 'stb_date_supplier_idx');
        });

        // ── Secondary Transport Bill Items (line rows) ───────────────────────
        Schema::create('secondary_transport_bill_items', function (Blueprint $table) {
            ...
            // ✅ FIXED: Custom short FK names — auto-names exceeded 64 char MySQL limit
