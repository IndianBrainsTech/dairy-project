        ...
        <div class="row">
            <div class="col-sm-12">
                @component('app-components.breadcrumb-3')
                    @slot('title') Incentive Mode @endslot
                    ...
                    <div class="card-body">
                        <div style="width:100%">
                            <div style="width:40%;float:left">
                                <h4 class="header-title mt-0">Incentive Mode &nbsp;
                        ...
                        <form action="{{ route('incentive.explorer') }}" method="POST" class="float-right">
                            @csrf
                            <div class="d-flex align-items-center">
                                <label class="mr-2 text-nowrap">Incentive Mode</label>
                                <select name="incentive_mode" class="form-control" style="min-width: 100px">
                                    <option value="All" @selected(old('incentive_mode', $incentive_mode) == 'All')>All</option>
                            ...
                            <table id="datatable" class="table table-sm table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th data-priority="2" class="text-center">Incentive Mode</th>
                                    </tr>
                                </thead>
                                <tbody>
