        ...
        <div class="modal-dialog" role="document" style="max-width: 450px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="mdl-title" class="modal-title mt-0">Department</h5>
    ...
    <script>
        $(document).ready(function () {
            ...
            function doInit() {
                ...
                $('.dropdown-menu .dropdown-item').on('click', function (e) {
                    ...
                    if(newStatus != oldStatus) {
                        window.location.href = "{{ route('departments.index') }}" + "?status=" + encodeURIComponent(newStatus);
                    }
                });
            ...
            function createMaster() {
                $mdlTitle.html("Create Department");
                $hdnId.val("");
                $txtCode.val("");
                $txtName.val("");
            ...
            function deleteMaster() {
                ...
                .then((result) => {
                    if (result.value) {
                        $.ajax({
                            url: "{{ route('departments.destroy', ['department' => '__ID__']) }}".replace('__ID__', id),
                            method: 'DELETE',
                            dataType: "json"
                        })
                        .done(response => {
            ...
            function submitMaster(event) {
                ...
                if(!id) {
                    ...
                    url = "{{ route('departments.update', ['department' => '__ID__']) }}".replace('__ID__', id);
                    method = "PUT";
                }
