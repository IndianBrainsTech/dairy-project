...
@section('title', 'Purchase Item Groups')
        ...
        <div class="row">
            <div class="col-12">
                @component('app-components.breadcrumb-4')
                    @slot('title') Purchase Item Groups @endslot
                            ...
                            <table id="datatable" class="table table-bordered table-sm table-hover dt-responsive nowrap w-100">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-left pl-2">Group Name</th>
                                        @if($status != "Active")
        ...
        <div class="modal-dialog" role="document" style="max-width: 450px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="mdl-title" class="modal-title mt-0">Item Group</h5>
                            ...
                            <div class="col-12">
                                <div class="form-group row" id="div-code">
                                    <label for="txt-code" class="col-sm-4 col-form-label">
                                        Group Code <small class="text-danger font-13">*</small>
                                    </label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    <label for="txt-name" class="col-sm-4 col-form-label">
                                        Group Name <small class="text-danger font-13">*</small>
                                    </label>
                                    <div class="col-sm-8">
...
@push('custom-scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            function doInit() {
                setMenuItemActive('Masters','ul-purchase-items','li-purchase-item-groups');
                ...
                $('.dropdown-menu .dropdown-item').on('click', function (e) {
                    ...
                    if(newStatus != oldStatus) {
                        window.location.href = "{{ route('purchase.items.groups.list') }}" + "?status=" + encodeURIComponent(newStatus);
                    }
                });
            ...
            function createMaster() {
                $mdlTitle.html("Create Item Group");
                $hdnId.val("");
                $txtCode.val("");
                $txtName.val("");
            ...
            function deleteMaster() {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: `Do you want to delete the group '${name}'?`,
                    icon: 'question',
                ...
                .then((result) => {
                    if (result.value) {
                        $.ajax({
                            url: "{{ route('purchase.items.groups.destroy', ['master' => '__ID__']) }}".replace('__ID__', id),
                            method: 'DELETE',
                            dataType: "json"
                        })
                        .done(response => {
            ...
            function submitMaster(event) {
                ...
                let url, method;
                if(!id) {
                    url = "{{ route('purchase.items.groups.store') }}";
                    method = "POST";
                }
                else {
                    url = "{{ route('purchase.items.groups.update', ['master' => '__ID__']) }}".replace('__ID__', id);
                    method = "PUT";
                }
