            ...
            <div class="col-lg-8 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body">                    
                        ...
                        <form class="mb-0" method="post" action="{{ route('products.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Product Name <small class="text-danger font-13">*</small></label>
                                        <input type="text" class="form-control" id="prod_name" name="prod_name" required="" maxlength="50">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Short Name <small class="text-danger font-13">*</small></label>
                                        <input type="text" class="form-control" id="short_name" name="short_name" required="" maxlength="15">
                                    </div>
                                </div><!--end col-->                                                
                            </div><!--end row-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" id="prod_desc" name="prod_desc" placeholder="writing here.."></textarea>
                                    </div>
                                </div><!--end col-->
                            </div><!--end row-->
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">                                        
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="mrp" name="mrp" required="" step="any" min="0">
                                        </div>
                                    </div>
                                </div><!--end col-->
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>FAT</label>
                                        <input type="number" class="form-control" id="fat" name="fat" step="any" min="0">
                                    </div>
                                </div> <!--end col-->
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>SNF</label>
                                        <input type="number" class="form-control" id="snf" name="snf" step="any" min="0">
                                    </div>           
                                </div> <!--end col-->                                               
                            </div><!--end row-->
                            <hr/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="hsn_code" name="hsn_code" required="">
                                            ...
                                            @foreach($hsn_codes as $hsnCode)
                                                <option value="{{ $hsnCode->hsn_code }}">{{ $hsnCode->hsn_code }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div><!--end col-->
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-check-inline my-1">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="rdo_taxable" name="tax_type" value="Taxable" class="custom-control-input" checked="" data-toggle="collapse" data-target="#collapseTaxData" aria-expanded="false" aria-controls="collapseTaxData">
                                                    <label class="custom-control-label" for="rdo_taxable">Taxable</label>
                                                </div>
                                            </div>
                                            <div class="form-check-inline my-1">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="rdo_exempted" name="tax_type" value="Exempted" class="custom-control-input" data-toggle="collapse" data-target="#collapseTaxData" aria-expanded="false" aria-controls="collapseTaxData">
                            ...
                            <div class="collapse show" id="collapseTaxData">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="gst">GST <small class="text-danger font-13">*</small></label>
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="gst" name="gst" min="0" max="50">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="sgst" name="sgst" min="0" max="50" step="0.50">
                                                <div class="input-group-append">
                                                    <span class="input-group-text"><i class="mdi mdi-percent"></i></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="cgst" name="cgst" min="0" max="50" step="0.50">
                                                <div class="input-group-append">
                                                    <span class="input-group-text"><i class="mdi mdi-percent"></i></span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="select_primary_unit" name="select_primary_unit" required="">
                                            ...
                                            @foreach($units as $unit)
                                                <option value="{{ $unit->id }},{{ $unit->display_name }}">{{ $unit->unit_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="primary_price" name="primary_price" step="any" min="0" required="">
                                        </div>                                        
                                    </div>
                                </div><!--end col-->
                            </div><!--end row-->
                                                ...
                                                <div data-repeater-item="" style="display:none;">
                                                    <div class="form-group row d-flex align-items-end">
                                                        ...
                                                        <div class="col-sm-4">
                                                            ...
                                                            <select name="units[0][unit_id]" class="form-control addi_unit">                                                               
                                                                @foreach($units as $unit)
                                                        ...
                                                        <div class="col-sm-3">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" class="form-control" name="units[0][price]" step="any" min="0" required="">
                                                            </div>                                                        
                                                        </div><!--end col-->
                                                        ...
                                                        <div class="col-sm-5">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-8 input-group">
                                                                    <input type="number" class="form-control" name="units[0][conversion]" step="any" min="0" required="">
                                                                    <div class="input-group-append">
                                ...
                                <div class="col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <input type="file" id="product_image" name="product_image" accept="image/*" class="dropify" />
                                        </div><!--end card-body-->
                                    </div><!--end card-->
                                </div><!--end col-->
                                <div class="col-xl-6">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="custom-control custom-switch switch-pink">
                                                                ...
                                                                <label class="custom-control-label" for="customSwitch1" id="labelCustomSwitch1">ON</label>
                                                            </div>   
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr height="50px">
                                                        ...
                                                        <td>
                                                            <div class="custom-control custom-switch switch-pink">                                                    
                                                                ...
                                                                <label class="custom-control-label" for="customSwitch2" id="labelCustomSwitch2">ON</label>
                                                            </div>   
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr height="30px">
                                                        ...
                                                        <td>
                                                            <div class="custom-control custom-switch switch-pink">                                                    
                                                                ...
                                                                <label class="custom-control-label" for="customSwitch3" id="labelCustomSwitch3">OFF</label>
                                                            </div>   
                                                        </td>
                                                    </tr>
                                                </table>
        ...
        $(document).ready(function () {
            ...
            $('#submit').click(function (event) {                
                ...
                if(valid) {
                    ...
                    if(image_name) {
                        valid = isExtensionValid(image_name);
                        if(!valid) {
