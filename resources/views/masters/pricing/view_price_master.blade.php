            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <h6 class="font-14 mb-3" style="color:#fd3c97">Price Master Data :</h6>
                            ...
                            <div class="col-lg-5 ml-4">
                                ...
                                <div class="table-responsive table-container">
                                    <table id="tablePriceList" class="table table-bordered table-sm">
                                        <thead class="thead-light">
                                            <tr>
                                                <th class="text-center" width="60px">S.No</th>
                                                <th>Product</th>
                        ...
                        <a href="{{ route('price-master.edit',['id'=>$id]) }}"><button class="btn btn-gradient-primary px-4 mr-3" type="button">Edit</button></a>
                        @if($status == "Active")
                            <a href="{{ route('price-master.status',['id'=>$id]) }}"><button class="btn btn-gradient-danger px-3" type="button">Set Inactive</button></a>
                        @else
                            <a href="{{ route('price-master.status',['id'=>$id]) }}"><button class="btn btn-gradient-primary px-3" type="button">Set Active</button></a>
                        @endif
