...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                @component('app-components.breadcrumb-3')
                    @slot('title') Petrol Bunks @endslot
        ...
        <div class="row">
            <div class="cols-12 col-md-10 col-lg-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                            ...
                            <button type="button" class="btn btn-pink btn-round font-weight-medium px-3 mb-2 mb-md-0">
                                {{ $bunks->count() }} {{ Str::plural('Bunk', $bunks->count()) }}
                            </button>
                            ...
                            <div class="d-flex flex-column flex-sm-row gap-2">
                                ...
                                <!-- Add button -->
                                <a href="{{ route('bunks.create') }}" class="btn btn-primary px-3 mb-2 mb-sm-0">
                                ...
                                <tbody>
                                    @foreach($bunks as $bunk)
                                        <tr>
                                            ...
                                            <td class="text-left pl-2">{{ $bunk->name }}</td>
                                            @if($status != "Active")
                                                <th class="text-center">{!! getStatusWithBadge($bunk->status) !!}</th>
                                            @endif
                                            <td class="text-center">
                                                <a href="{{ route('bunks.show', ['bunk' => $bunk->id]) }}">
        ...
        $(document).ready(function () {
            ...
            $('.dropdown-menu .dropdown-item').on('click', function (e) {
                ...
                if(newStatus != oldStatus) {
                    window.location.href = "{{ route('bunks.list') }}" + "?status=" + encodeURIComponent(newStatus);
                }
            });
        });
    </script>
