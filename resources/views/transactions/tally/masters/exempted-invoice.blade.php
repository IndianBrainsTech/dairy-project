        ...
        <IMPORTDATA>
            ...
            <REQUESTDATA>
                <TALLYMESSAGE xmlns:UDF="TallyUDF">
                    <VOUCHER REMOTEID="{{ $voucher->remote_id }}" VCHTYPE="{{ $voucher->voucher_type }}" ACTION="Create" OBJVIEW="Invoice Voucher View">
                        ...
                        <VOUCHERTYPENAME>{{ $voucher->voucher_type }}</VOUCHERTYPENAME>
                        <VOUCHERTYPEORIGNAME>{{ $voucher->voucher_type }}</VOUCHERTYPEORIGNAME>
                        ...
                        @foreach($items as $item)
                            <ALLINVENTORYENTRIES.LIST>
                                ...
                                <ACCOUNTINGALLOCATIONS.LIST>
                                    <LEDGERNAME>{{ $voucher->ledger }}</LEDGERNAME>
                                    <ISDEEMEDPOSITIVE>No</ISDEEMEDPOSITIVE>
                                    <AMOUNT>{{ $item->amount }}</AMOUNT>                                    
                                </ACCOUNTINGALLOCATIONS.LIST>
                            </ALLINVENTORYENTRIES.LIST>
