...
@section('title', 'View Diesel Bill Statements')
        ...
        <div class="row">
            <div class="col-12">
                @component('app-components.breadcrumb-4')
                    @slot('title') View Diesel Bill Statements @endslot
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="frm-filter" method="get" action="{{ route('diesel-bills.statements.index') }}" aria-label="Diesel bill statement filter">
                            <div class="row">
    ...
    <script>
        $(document).ready(function () {
            ...
            const table = $('#datatable').DataTable({
                ...
                pageLength: 25,
                language: {
                    emptyTable: "No diesel bill statement found for the date range."
                }
            });
