        ...
        <div class="row">
            <div class="col-sm-12">
                @component('app-components.breadcrumb-3')
                    @slot('title') Create Receipt @endslot
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group row mb-2">
                                    ...
                                    <input type="date" id="rcptDate" value="{{ date('Y-m-d') }}" class="form-control" style="max-width:130px">
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group row mb-2">
                                    <label for="route" class="col-form-label mr-2">Route</label>
                                    <select name="route" id="route" class="form-control" style="max-width:200px">
                                    ...
                                    <div class="my-border">
                                        <div class="form-check-inline my-1 pr-2">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" name="mode" id="rdoCash" class="custom-control-input" checked="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group float-right">
                                            ...
                                            <input type="text" id="rcptAmt" class="form-control text-center int-input" style="max-width:110px">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group row">
                                            ...
                                            <input type="text" id="advanceAmt" class="form-control text-center" style="max-width:110px" readonly>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group row float-right">
                                            <label for="excessAmt" class="col-form-label mx-2">Excess Balance</label>
                                            <input type="text" id="excessAmt" class="form-control text-center mr-3" style="max-width:110px" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input type="text" id="transNum" class="form-control col-sm-7">
                                            </div>
                                            <div class="form-group row">
                                                <label for="remarks" class="col-form-label col-sm-4">Remarks</label>
                                                <textarea id="remarks" rows="3" class="form-control col-sm-7"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row float-right">
                                    ...
                                    <input type="button" id="submit" class="btn btn-primary mr-3" value="Submit" data-toggle="tooltip" data-placement="top" title="Alt+S"/>
                                </div>
                            </div>
                        </div>
...
@push('custom-scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            let incentives;
            let note1;
            const dateSettings = @json($date_settings);
                ...
                $.get(url, function(data) {
                    ...
                    invoices.forEach(function(item) {
                        const newRow = $("<tr>")
                            ...
                            .append(`<td id='oustd${i}'>${item.outstanding}</td>`)
                    ...
                    $('#oustd').text($oustd);
                    if(data.amount)
                        $('#advanceAmt').val(data.amount.excess_amt);

                    $('#incentiveTable tbody').empty();
                    $('#incentiveAmount').text('');
                    incentives = data.incentives;
                    let incAmt = 0;
                    data.incentives.forEach(function(item) {
                        const newRow = $("<tr>")
            ...
            function restrictDate(dateControl) {
                ...
                let today = new Date();
                // let day1 = new Date('2025-04-01');
                let day1 = new Date('2026-01-21');
...
/*
            function restrictDateForCashMode() {
                const date = getTodayFormatted();
                $('#rcptDate').attr('min', date);
                $('#rcptDate').attr('max', date);
            }
*/
            function restrictDateForCashMode() {
                $('#rcptDate').attr('min', dateSettings['cash']['min_date']);
                $('#rcptDate').attr('max', dateSettings['cash']['max_date']);
                $('#rcptDate').val(today);
            }

            function restrictDateForBankMode() {                
                $('#rcptDate').attr('min', dateSettings['bank']['min_date']);
                $('#rcptDate').attr('max', dateSettings['bank']['max_date']);
                $('#rcptDate').val(today);
            }
        });
    </script>
