...
@section('title', 'Vehicle Route Mappings')
@section('headerStyle')
...
<div class="container-fluid">
    <div class="row"><div class="col-12">
        @component('app-components.breadcrumb-4')
            @slot('title') Vehicle Route Mappings @endslot
            @slot('item1') Transport @endslot @slot('item2') Mappings @endslot @slot('item3') Vehicle Route Mappings @endslot
        @endcomponent
    </div></div>
    ...
    <div class="card"><div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('transport.vehicle-route-mappings.create') }}" class="btn btn-primary px-3">
        ...
        <div class="table-responsive">
            <table id="datatable" class="table table-bordered table-sm table-hover dt-responsive nowrap w-100">
                <thead class="thead-light"><tr>
                    ...
                    <th>Vehicle</th><th>Route</th><th>Route Type</th><th>Shift</th><th class="text-center">Status</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ ucfirst($record->route_type) }}</td>
                        <td>{{ $record->shift ?? '—' }}</td>
                        ...
                        <td class="text-center">
                            <a href="{{ route('transport.vehicle-route-mappings.show', $record) }}" class="mr-1"><i class="dripicons-preview text-primary font-18"></i></a>
                            <a href="{{ route('transport.vehicle-route-mappings.edit', $record) }}"><i class="dripicons-pencil text-warning font-18"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
